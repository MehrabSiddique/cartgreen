        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 flex flex-col justify-between">
          <div>
            ...
            <p className="mb-2 text-gray-600">
              <strong>Email:</strong> abcsupport@greencart.com
            </p>
            <p className="mb-2 text-gray-600">
              <strong>Phone:</strong> +92 301 1234567
            </p>
            <p className="mb-4 text-gray-600">
              <strong>Address:</strong> GreenCart , Faisalabad, Pakistan
            </p>
          </div>
          <iframe
            title="Location Map"
            src="https://maps.google.com/maps?q=Faisalbad&t=&z=13&ie=UTF8&iwloc=&output=embed"
